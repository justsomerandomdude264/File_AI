    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      <div className="container mx-auto px-8">
        ...
        <div className="py-2 text-center">
          ...
          <Link
            href="/dashboard"
            className="inline-flex px-8 py-3 rounded-lg font-semibold text-lg animate-wiggle text-white items-center bg-gradient-to-r from-green-700 from-10% via-emerald-500 via-30% to-emerald-700 hover:from-green-600 hover:via-emerald-500 hover:to-emerald-600"
          >
            Try FileAI Now
